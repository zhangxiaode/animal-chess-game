    ...
    execute: function () {
      ...
      _export("GamePage", GamePage = (_dec = ccclass('GamePage'), _dec(_class = class GamePage extends Component {
        ...
        _createUI() {
          ...
          const pageWidth = (_pageSize$width = pageSize == null ? void 0 : pageSize.width) != null ? _pageSize$width : 640;
          const pageHeight = (_pageSize$height = pageSize == null ? void 0 : pageSize.height) != null ? _pageSize$height : 960;

          const backBtnHalfWidth = this._scaled(90, uiScale);

          const backBtnHalfHeight = this._scaled(31, uiScale);

          const safeMargin = this._scaled(20, uiScale);
        ...
        _createDiscardPopup(parent) {
          ...
          const pageSize = pageTransform == null ? void 0 : pageTransform.contentSize;
          const pageWidth = (_pageSize$width2 = pageSize == null ? void 0 : pageSize.width) != null ? _pageSize$width2 : 640;
          const pageHeight = (_pageSize$height2 = pageSize == null ? void 0 : pageSize.height) != null ? _pageSize$height2 : 960;
          ...
          const dialogWidth = this._scaled(420, uiScale);

          const dialogHeight = this._scaled(220, uiScale);
          ...
          const confirmBtn = this._createPopupButton(dialogNode, 'ConfirmDiscardBtn', '确定', new Vec3(this._scaled(-90, uiScale), this._scaled(-45, uiScale), 0));

          confirmBtn.node.on(Button.EventType.CLICK, this._confirmPlayerDiscard, this);

          const cancelBtn = this._createPopupButton(dialogNode, 'CancelDiscardBtn', '取消', new Vec3(this._scaled(90, uiScale), this._scaled(-45, uiScale), 0));
        ...
        _createCapturePopup(parent) {
          ...
          const pageTransform = parent.getComponent(UITransform);
          const pageSize = pageTransform == null ? void 0 : pageTransform.contentSize;
          const pageWidth = (_pageSize$width3 = pageSize == null ? void 0 : pageSize.width) != null ? _pageSize$width3 : 640;
          const pageHeight = (_pageSize$height3 = pageSize == null ? void 0 : pageSize.height) != null ? _pageSize$height3 : 960;
          ...
          const maskTransform = this._capturePopupRoot.addComponent(UITransform);

          maskTransform.setContentSize(pageWidth, pageHeight);

          const maskGraphics = this._capturePopupRoot.addComponent(Graphics);
          ...
          const dialogWidth = this._scaled(500, uiScale);

          const dialogHeight = this._scaled(240, uiScale);
          ...
          const confirmBtn = this._createPopupButton(dialogNode, 'ConfirmCaptureBtn', '确定', new Vec3(this._scaled(-90, uiScale), this._scaled(-50, uiScale), 0));

          confirmBtn.node.on(Button.EventType.CLICK, this._confirmPlayerCapture, this);

          const cancelBtn = this._createPopupButton(dialogNode, 'CancelCaptureBtn', '取消', new Vec3(this._scaled(90, uiScale), this._scaled(-50, uiScale), 0));

          cancelBtn.node.on(Button.EventType.CLICK, this._cancelPlayerCapture, this);
        }

        _createPopupButton(parent, nodeName, text, position) {
          const uiScale = this._getUiScale(this.node.getComponent(UITransform));
          ...
          const buttonWidth = this._scaled(140, uiScale);

          const buttonHeight = this._scaled(60, uiScale);
        ...
        _createResultPopup(parent) {
          ...
          const pageTransform = parent.getComponent(UITransform);
          const pageSize = pageTransform == null ? void 0 : pageTransform.contentSize;
          const pageWidth = (_pageSize$width4 = pageSize == null ? void 0 : pageSize.width) != null ? _pageSize$width4 : 640;
          const pageHeight = (_pageSize$height4 = pageSize == null ? void 0 : pageSize.height) != null ? _pageSize$height4 : 960;
          ...
          const dialogWidth = this._scaled(440, uiScale);

          const dialogHeight = this._scaled(260, uiScale);
        ...
        _createUserInfoPanel(parent) {
          ...
          const uiScale = this._getUiScale(parent.getComponent(UITransform));
          ...
          const panelWidth = this._scaled(560, uiScale);

          const panelHeight = this._scaled(120, uiScale);
          ...
          const starsRightPadding = this._scaled(24, uiScale);
        ...
        _createActionTipLabels(parent) {
          const uiScale = this._getUiScale(parent.getComponent(UITransform)); // 用户操作提示（在用户信息下方）
        ...
        _generateRandomOpponentInfo() {
          ...
          const canPromoteOneStep = !(myRank.tier === (_crd && RankTier === void 0 ? (_reportPossibleCrUseOfRankTier({
            error: Error()
          ...
          const maxStars = Math.max(1, (_requirement$starsNee = requirement == null ? void 0 : requirement.starsNeeded) != null ? _requirement$starsNee : 10);
        ...
        _drawGameBoard() {
          ...
          const pageWidth = (_pageTransform$conten2 = pageTransform == null ? void 0 : pageTransform.contentSize.width) != null ? _pageTransform$conten2 : 640;
          ...
          const boardTransform = (_this$_boardRoot$getC = this._boardRoot.getComponent(UITransform)) != null ? _this$_boardRoot$getC : this._boardRoot.addComponent(UITransform);
          boardTransform.setContentSize(boardPixelSize, boardPixelSize);

          if (this._backBtn) {
            var _pageTransform$conten3;

            const pageHeight = (_pageTransform$conten3 = pageTransform == null ? void 0 : pageTransform.contentSize.height) != null ? _pageTransform$conten3 : 960;
          ...
          const boardCenterY = (_this$_boardRoot$posi = (_this$_boardRoot = this._boardRoot) == null ? void 0 : _this$_boardRoot.position.y) != null ? _this$_boardRoot$posi : 20;

          const infoMargin = this._scaled(24, uiScale);

          const userPanelHalfHeight = ((_this$_userInfoRoot$g = (_this$_userInfoRoot = this._userInfoRoot) == null || (_this$_userInfoRoot = _this$_userInfoRoot.getComponent(UITransform)) == null ? void 0 : _this$_userInfoRoot.contentSize.height) != null ? _this$_userInfoRoot$g : this._scaled(120, uiScale)) / 2;
          const opponentPanelHalfHeight = ((_this$_opponentInfoRo = (_this$_opponentInfoRo2 = this._opponentInfoRoot) == null || (_this$_opponentInfoRo2 = _this$_opponentInfoRo2.getComponent(UITransform)) == null ? void 0 : _this$_opponentInfoRo2.contentSize.height) != null ? _this$_opponentInfoRo : this._scaled(120, uiScale)) / 2;
          ...
          const graphics = (_this$_boardRoot$getC2 = this._boardRoot.getComponent(Graphics)) != null ? _this$_boardRoot$getC2 : this._boardRoot.addComponent(Graphics);
          graphics.clear();
          ...
          for (let row = 0; row < this._boardSize; row++) {
            for (let col = 0; col < this._boardSize; col++) {
              ...
              const isSelectedMovePiece = !!this._selectedMovePiece && this._selectedMovePiece[0] === row && this._selectedMovePiece[1] === col;
              const isPendingDiscardPiece = !!this._pendingDiscardPoint && this._pendingDiscardPoint[0] === row && this._pendingDiscardPoint[1] === col;
        ...
        _doAiPlacement() {
          ...
          const aiRankTier = (_this$_opponentInfo$t = (_this$_opponentInfo = this._opponentInfo) == null ? void 0 : _this$_opponentInfo.tier) != null ? _this$_opponentInfo$t : (_crd && RankTier === void 0 ? (_reportPossibleCrUseOfRankTier({
            error: Error()
          }), RankTier) : RankTier).BRONZE;
          const aiRankPhase = (_this$_opponentInfo$p = (_this$_opponentInfo2 = this._opponentInfo) == null ? void 0 : _this$_opponentInfo2.phase) != null ? _this$_opponentInfo$p : (_crd && RankPhase === void 0 ? (_reportPossibleCrUseOfRankPhase({
            error: Error()
          }), RankPhase) : RankPhase).EARLY;
        ...
        _doAiMovement() {
          ...
          const aiRankTier = (_this$_opponentInfo$t2 = (_this$_opponentInfo3 = this._opponentInfo) == null ? void 0 : _this$_opponentInfo3.tier) != null ? _this$_opponentInfo$t2 : (_crd && RankTier === void 0 ? (_reportPossibleCrUseOfRankTier({
            error: Error()
          }), RankTier) : RankTier).BRONZE;
          const aiRankPhase = (_this$_opponentInfo$p2 = (_this$_opponentInfo4 = this._opponentInfo) == null ? void 0 : _this$_opponentInfo4.phase) != null ? _this$_opponentInfo$p2 : (_crd && RankPhase === void 0 ? (_reportPossibleCrUseOfRankPhase({
            error: Error()
          }), RankPhase) : RankPhase).EARLY;
        ...
        _resolveCaptureAfterAction(row, col, pieceType, isPlayer, onComplete) {
          ...
          let shouldCapture = true;
          {
            ...
            const aiRankTier = (_this$_opponentInfo$t3 = (_this$_opponentInfo5 = this._opponentInfo) == null ? void 0 : _this$_opponentInfo5.tier) != null ? _this$_opponentInfo$t3 : (_crd && RankTier === void 0 ? (_reportPossibleCrUseOfRankTier({
              error: Error()
            }), RankTier) : RankTier).BRONZE;
            const aiRankPhase = (_this$_opponentInfo$p3 = (_this$_opponentInfo6 = this._opponentInfo) == null ? void 0 : _this$_opponentInfo6.phase) != null ? _this$_opponentInfo$p3 : (_crd && RankPhase === void 0 ? (_reportPossibleCrUseOfRankPhase({
              error: Error()
            }), RankPhase) : RankPhase).EARLY;
        ...
        _confirmPlayerCapture() {
          const decision = this._pendingCaptureDecision;
        ...
        _canMakeValidMove(pieceType) {
          ...
          for (const piece of ownPieces) {
            const [row, col] = piece; // 检查四个正交方向的相邻格子
...
//# sourceMappingURL=150483796c2769ba9a9b1ba5e74b11ed251d0873.js.map