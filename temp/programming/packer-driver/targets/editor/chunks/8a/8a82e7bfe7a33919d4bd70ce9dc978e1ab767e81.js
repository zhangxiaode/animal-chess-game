    ...
    execute: function () {
      ...
      _export("GameMain", GameMain = (_dec = ccclass('GameMain'), _dec(_class = (_class2 = class GameMain extends Component {
        ...
        start() {
          ...
          const homePage = homePageNode.addComponent(_crd && HomePage === void 0 ? (_reportPossibleCrUseOfHomePage({
            error: Error()
          }), HomePage) : HomePage);
          (_crd && UIManager === void 0 ? (_reportPossibleCrUseOfUIManager({
            error: Error()
...
//# sourceMappingURL=8a82e7bfe7a33919d4bd70ce9dc978e1ab767e81.js.map