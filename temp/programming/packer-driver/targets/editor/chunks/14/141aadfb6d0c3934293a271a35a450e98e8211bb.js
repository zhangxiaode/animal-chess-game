  ...
  return {
    ...
    execute: function () {
      ...
      _export("GamePage", GamePage = (_dec = ccclass('GamePage'), _dec(_class = class GamePage extends Component {
        ...
        _drawGameBoard() {
          var _pageTransform$conten, _this$_boardRoot$getC, _this$_boardRoot$posi, _this$_boardRoot, _this$_boardRoot$getC2;
        ...
        _onBoardTouch(event) {
          var _this$_discardPopupRo;

          if (this._isGameOver || this._isAiThinking || this._currentTurn !== 1 || !this._boardRoot || (_this$_discardPopupRo = this._discardPopupRoot) != null && _this$_discardPopupRo.active) {
            return;
          }
        ...
        _resolveCaptureAfterAction(row, col, pieceType, isPlayer) {
...
//# sourceMappingURL=141aadfb6d0c3934293a271a35a450e98e8211bb.js.map