      ...
      _export("DesktopPopup", DesktopPopup = (_dec = ccclass('DesktopPopup'), _dec(_class = class DesktopPopup extends Component {
        ...
        _loadImages() {
          ...
          return _asyncToGenerator(function* () {
            yield Promise.all([_this._setSpriteFrame(_this._dialogSprite, 'images/popup/dialog_bg', '[DesktopPopup] 弹框背景加载失败: images/popup/dialog_bg'), _this._setSpriteFrame(_this._titleSprite, 'images/popup/title_bg', '[DesktopPopup] 标题背景加载失败: images/popup/title_bg'), _this._setSpriteFrame(_this._closeSprite, 'images/popup/close', '[DesktopPopup] 关闭按钮图片加载失败: images/popup/close'), _this._setSpriteFrame(_this._contentSprite, 'images/popup/desktop-img', '[DesktopPopup] 内容图片加载失败: images/popup/desktop-img'), _this._setSpriteFrame(_this._submitButtonSprite, 'images/popup/btn_yellow', '[DesktopPopup] 提交按钮背景加载失败: images/popup/btn_yellow')]);
          })();
        }
        ...
        _onSubmit() {
          ...
          return _asyncToGenerator(function* () {
            ...
            var result = yield (_crd && addToDesktopShortcut === void 0 ? (_reportPossibleCrUseOfaddToDesktopShortcut({
              error: Error()
