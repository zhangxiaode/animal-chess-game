    ...
    execute: function () {
      ...
      _export("GamePage", GamePage = (_dec = ccclass('GamePage'), _dec(_class = class GamePage extends Component {
        ...
        _createUI() {
          ...
          var backBtnHalfWidth = 90;
          var backBtnHalfHeight = 31;
          var safeMargin = 20;
        ...
        _createDiscardPopup(parent) {
          ...
          var confirmBtn = this._createPopupButton(dialogNode, 'ConfirmDiscardBtn', '确定', new Vec3(-90, -45, 0));

          confirmBtn.node.on(Button.EventType.CLICK, this._confirmPlayerDiscard, this);

          var cancelBtn = this._createPopupButton(dialogNode, 'CancelDiscardBtn', '取消', new Vec3(90, -45, 0));
        ...
        _createResultPopup(parent) {
          ...
          var closeBtn = this._createPopupButton(dialogNode, 'CloseResultBtn', '确定', new Vec3(0, -70, 0));
