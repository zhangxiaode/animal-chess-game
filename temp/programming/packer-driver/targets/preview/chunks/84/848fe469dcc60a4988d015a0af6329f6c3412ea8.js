    ...
    execute: function () {
      ...
      _export("GamePage", GamePage = (_dec = ccclass('GamePage'), _dec(_class = class GamePage extends Component {
        ...
        _createResultPopup(parent) {
          ...
          var homeBtn = this._createPopupButton(dialogNode, 'HomeResultBtn', 'Homepage', new Vec3(this._scaled(-90, uiScale), this._scaled(-70, uiScale), 0));

          homeBtn.node.on(Button.EventType.CLICK, this._goHomeFromResult, this);

          var nextBtn = this._createPopupButton(dialogNode, 'NextResultBtn', 'Next', new Vec3(this._scaled(90, uiScale), this._scaled(-70, uiScale), 0));
