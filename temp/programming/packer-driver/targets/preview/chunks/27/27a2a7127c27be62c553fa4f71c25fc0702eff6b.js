      ...
      PAGE_MODULE_MAP = {
        HomePage: function () {
          var _HomePage = _asyncToGenerator(function* () {
            return (yield _context.import("__unresolved_2")).HomePage;
          });
        ...
        GamePage: function () {
          var _GamePage = _asyncToGenerator(function* () {
            return (yield _context.import("__unresolved_3")).GamePage;
          });
        ...
        RulesPage: function () {
          var _RulesPage = _asyncToGenerator(function* () {
            return (yield _context.import("__unresolved_4")).RulesPage;
          });
