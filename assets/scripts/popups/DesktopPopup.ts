...
import { addToDesktopShortcut } from '../utils/ShortcutUtils';

const { ccclass } = _decorator;

@ccclass('DesktopPopup')
export class DesktopPopup extends Component {
    ...
    private async _loadImages() {
        await Promise.all([
            this._setSpriteFrame(this._dialogSprite, 'images/popup/dialog_bg', '[DesktopPopup] 弹框背景加载失败: images/popup/dialog_bg'),
            this._setSpriteFrame(this._titleSprite, 'images/popup/title_bg', '[DesktopPopup] 标题背景加载失败: images/popup/title_bg'),
            this._setSpriteFrame(this._closeSprite, 'images/popup/close', '[DesktopPopup] 关闭按钮图片加载失败: images/popup/close'),
            this._setSpriteFrame(this._contentSprite, 'images/popup/desktop-img', '[DesktopPopup] 内容图片加载失败: images/popup/desktop-img'),
            this._setSpriteFrame(this._submitButtonSprite, 'images/popup/btn_yellow', '[DesktopPopup] 提交按钮背景加载失败: images/popup/btn_yellow'),
        ]);
    }
    ...
    private async _onSubmit() {
        ...
        const result = await addToDesktopShortcut();
